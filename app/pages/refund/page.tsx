        ...
        <div className="mx-auto grid gap-8 lg:gap-12 prose max-w-3xl lg:prose-lg xl:prose-2xl">
          ...
          <div className="space-y-10">
            <section className="space-y-4">
              <p>
                {" "}
                SAMPURNAKART INNOVATIONS PRIVATE LIMITED believes in helping its
            ...
            <section className="space-y-4">
              <p>
                SAMPURNAKART INNOVATIONS PRIVATE LIMITED does not accept
            ...
            <section className="space-y-4">
              <p>
                ...
                case of any Refunds approved by the SAMPURNAKART INNOVATIONS
